...
public class BankmainApp {
	...
	public static void main(String[] args) {
		users.add(new Users("Ravi", "Tumakur", "9897888766", "raghu123", "Ravi@123", 20000, "05-10-2021"));
		users.add(new Users("Vamika", "Mysore", "9877833766", "vasu123", "Vamika@123", 10000, "05-09-2021"));
