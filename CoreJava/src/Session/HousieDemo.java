...
public class HousieDemo {
	...
	static class Node {
		...
		private void sortColumnWithThreeNumbers(int c) throws Exception {
			...
			if (emptyCell != -1) {
				throw new Exception("Hey! your column has greater than 3 cells filled , invalid function called!!!!!");
			}
	...
	public static void main(String[] args) {
		...
		// Assigning element from last column to random set
